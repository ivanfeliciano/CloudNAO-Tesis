...
\sphinxcaption{Atributos principales del cómputo en la nube}\label{\detokenize{chapter_one/cloud_computing:key-cloud-computing-attr}}
\sphinxaftercaption
...
\centering
\sphinxcapstartof{table}
\sphinxcaption{Atributos principales de los servicios en la nube}\label{\detokenize{chapter_one/cloud_computing:key-cloud-services-attr}}
\sphinxaftercaption
\begin{tabulary}{\linewidth}[t]{|T|T|}
\hline
\sphinxstylethead{ 
