...
a partir de conceptos más simples. La figura muestra como un sistema de aprendizaje profundo
...
\begin{figure}[h]
    \centering
    \includegraphics{conv_operation.png}
...
\sphinxcaption{Algunos de los tipos de operaciones en TensorFlow.}\label{\detokenize{chapter_one/tensorflow:operations}}
\sphinxaftercaption
%\begin{tabulary}
...
\centering
\sphinxcapstartof{table}
\sphinxcaption{Definición de la función XOR.\label{table:xor}}
\sphinxaftercaption
...
Finalmente se ejecuta la gráfica de TensorFlow. Se crea una instacia de \sphinxcode{Session} e iteramos ejecutando el método \sphinxcode{run}
