...
\item {} 
Configurar un directorio de proyectos. Agregar archivos para la aplicación web y agregar activos estáticos a la carpeta local de Hosting. A continuación, se puede ejecutar \sphinxcode{firebase serve} para un sitio en forma local.

\item {} 
Implementar el sitio. Cuando esté
completa la configuración, ejecutar \sphinxcode{firebase deploy} para subir la última instantánea a los servidores de Firebase.
