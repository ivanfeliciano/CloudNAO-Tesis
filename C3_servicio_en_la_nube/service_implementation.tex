...
demás casos. Los vectores posibles de acuerdo con las cuatro categorías son los siguientes:
...
está dentro del módulo \sphinxcode{\sphinxupquote{cnn\_indoor\_classifier\_model}}.
...
\item La creación de la primera capa de convolución, recibe como entradas el placeholder
...
\PYG{g+go}{0;0.768813;1.579813;1.459016;0.13778409}
\PYG{g+gp}{...}
\PYG{g+go}{3000;68.318763;0.003628;0.110226;0.969223}
\PYG{g+go}{Time 68.318808}
\end{sphinxVerbatim}
...
Los modelos con mayor precisión son (1) y
...
\renewcommand*\thesubfigure{\arabic{subfigure}} 
  \centering
\subfloat[2 Convo 2 FC]{\includegraphics[scale=0.25]{model1}}
\qquad
\subfloat[2 Convo 2 FC]{\includegraphics[scale=0.25]{model2}}
\qquad
\subfloat[2 Convo 1 FC]{\includegraphics[scale=0.25]{model3}}
\qquad
\subfloat[1 Convo 2 FC]{\includegraphics[scale=0.25]{model4}}
\qquad
\subfloat[1 Convo 1 FC]{\includegraphics[scale=0.25]{model5}}
