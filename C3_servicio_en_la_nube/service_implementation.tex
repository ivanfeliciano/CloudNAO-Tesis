...
\begin{figure}[!ht]
  \centering
\subfloat[Modelo (1) 2 Convo 2 FC]{\includegraphics[scale=0.3]{model1}}
\qquad
\subfloat[Modelo (2) 2 Convo 2 FC]{\includegraphics[scale=0.3]{model2}}
\qquad
\subfloat[Modelo (3) 2 Convo 1 FC]{\includegraphics[scale=0.3]{model3}}
\qquad
\subfloat[Modelo (4) 1 Convo 2 FC]{\includegraphics[scale=0.3]{model4}}
\qquad
\subfloat[Modelo (5) 1 Convo 1 FC]{\includegraphics[scale=0.3]{model5}}
...
\subsection{Modelo en la API REST de CloudNAO}

Para finalizar la implementación del modelo sobre la arquitectura
se debe integrar uno de los cinco descritos en la tabla \ref{table:models_results} sobre la API REST de CloudNAO.
...
Dentro de la API TEST la clase que se encargar de restaurar la gráfica y valores del modelo
