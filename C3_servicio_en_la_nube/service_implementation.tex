...
\qquad
\subfloat[Clase = salida, predicción = oficina. Tiempo = 3.64]{\includegraphics[scale=1]{exit_incorrect}}
\qquad
\subfloat[Clase = zona de trabajo, predicción = oficina. Tiempo = 5.21]{\includegraphics[scale=1]{deks_incorrect}}
\qquad
\subfloat[Clase = oficina, predicción = oficina. Tiempo = 3.53]{\includegraphics[scale=1]{nao_api_office}}
