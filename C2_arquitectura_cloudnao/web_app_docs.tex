...
\item {} 
Muestra una imagen tomada con la cámara superior del robot, funciona para obtener una imagen en vivo enviada por el robot cuando está conectado a Firebase.
