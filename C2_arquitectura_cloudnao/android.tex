...
\begin{figure}[!h]
    ...
    \subfloat{\includegraphics[scale=.1]{rc_image}}%
    \qquad
    \subfloat{\includegraphics[scale=.1]{rc_no_image}}%
...
\begin{figure}[!h]
    ...
    en Firebase.}
    \subfloat{\includegraphics[scale=.1]{memory_list_checked}}%
    \qquad
    \subfloat{\includegraphics[scale=.1]{memory_list_unchecked}}%
    \qquad
...
\begin{figure}[!h]
    \centering
    \subfloat{\includegraphics[scale=.1]{object}}%
    \qquad
    \subfloat{\includegraphics[scale=.1]{object2}}%
...
\begin{figure}[!h]
    \centering
    \subfloat{\includegraphics[scale=.1]{ocr_before}}%
    \qquad
    \subfloat{\includegraphics[scale=.1]{ocr_after}}%
