...
que permite interactuar con el robot sin necesidad de ejecutar programas de manera local. Se conecta con el robot usando el SDK para Android de NAOqi, hace peticiones
...
aplicación: la parte que ve el usuario final y los componentes
...
\textbf{Autenticación de usuarios.}
...
\textbf{Selección y adición de robots a la aplicación.}
...
\textbf{Conexión con un robot seleccionado.}
...
\textbf{Guarda valores de ALMemory en la nube.}
...
\textbf{Detección de rostros y reconocimiento de sujetos en una fotografía enviada por el robot.}
...
\textbf{Detección de objetos de entre 80 categorías en una imagen de la cámara del robot.}
...
\textbf{Reconocimiento óptico de caracteres y traducción de texto encontrados en una imagen enviada por el robot.}
...
Método abstracto que sirve como callback
