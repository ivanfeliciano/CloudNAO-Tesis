...
para la comlumna de la base de datos. \sphinxcode{Integer, Float, String, Text}, son
...
pertenece \sphinxcode{id\_usuario = db.Column(db.Integer, db.ForeignKey('usuarios.id'))}.
...
Añadir tuplas
&
\sphinxcode{db.session.add(Objeto){}`}
&
...
Modificar tupas
&
\sphinxcode{Objeto.atributo\_a\_actualizar = nuevo\_valor} \sphinxcode{db.session.add(Objeto)}
&
...
Eliminar tuplas
&
\sphinxcode{db.session.delete(Objeto)}
&
...
Consultas
&
\sphinxcode{Modelo.query.all()} \sphinxcode{Modelo.query.filter\_by(Criterio)}
&
...
El Constructor de la clase recibe como parámetros el nombre del usuario
y la contraseña, la cuál se pasa por una función hash, usando la función
\sphinxcode{generate\_password\_hash} del módulo \sphinxcode{werkzeug.security}. También se
genera un token de accesso único usando el método {\hyperref[\detokenize{chapter_two/desc_cloudnao:app.models.user_model.UserModel.generate_token}]{\sphinxcrossref{\sphinxcode{generate\_token()}}}}.
\begin{quote}\begin{description}
\item[{Parámetros}] \leavevmode\begin{itemize}
\item {} 
\sphinxstyleliteralstrong{username} (\sphinxstyleliteralemphasis{string}) \textendash{} El nombre del usuario.

\item {} 
\sphinxstyleliteralstrong{password} (\sphinxstyleliteralemphasis{string}) \textendash{} La contraseña del usuario.

\end{itemize}

\end{description}\end{quote}
\index{find\_by\_access\_token() (método de clase de app.models.user\_model.UserModel)}

\begin{fulllineitems}
\phantomsection\label{\detokenize{chapter_two/desc_cloudnao:app.models.user_model.UserModel.find_by_access_token}}\pysiglinewithargsret{\sphinxbfcode{classmethod }\sphinxbfcode{find\_by\_access\_token}}{\emph{access\_token}}{}~
Hace la consulta a la base de datos de acuerdo al token
de acceo del usuario.
Retorn el primer registro donde el \sphinxcode{access\_token} coincida,
si no encuentra nada regresa un objeto \sphinxcode{None}
\begin{quote}\begin{description}
\item[{Parámetros}] \leavevmode
\sphinxstyleliteralstrong{access\_token} \textendash{} El token de acceso que se desea consultar.

\item[{Devuelve}] \leavevmode
Un objeto \sphinxcode{UserModel} que representa al usuario encontrado ó None si no hubo coincidencias.

\item[{Tipo del valor devuelto}] \leavevmode
\sphinxcode{UserModel} ó None.

\end{description}\end{quote}

\end{fulllineitems}

\index{find\_by\_id() (método de clase de app.models.user\_model.UserModel)}

\begin{fulllineitems}
\phantomsection\label{\detokenize{chapter_two/desc_cloudnao:app.models.user_model.UserModel.find_by_id}}\pysiglinewithargsret{\sphinxbfcode{classmethod }\sphinxbfcode{find\_by\_id}}{\emph{\_id}}{}~
Hace la consulta a la base de datos de acuerdo al id del usuario.
Retorn el primer registro donde el \sphinxcode{\_id} coincida, si no encuentra
nada regresa un objeto \sphinxcode{None}.
\begin{quote}\begin{description}
\item[{Parámetros}] \leavevmode
\sphinxstyleliteralstrong{\_id} \textendash{} El id de usuario que se desea consultar.
...
\index{find\_by\_username() (método de clase de app.models.user\_model.UserModel)}

\begin{fulllineitems}
\phantomsection\label{\detokenize{chapter_two/desc_cloudnao:app.models.user_model.UserModel.find_by_username}}\pysiglinewithargsret{\sphinxbfcode{classmethod }\sphinxbfcode{find\_by\_username}}{\emph{username}}{}~
Hace la consulta a la base de datos de acuerdo al nombre de usuario.
Retorn el primer registro donde el \sphinxcode{username} coincida, si no encuentra
nada regresa un objeto \sphinxcode{None}
\begin{quote}\begin{description}
\item[{Parámetros}] \leavevmode
\sphinxstyleliteralstrong{username} (\sphinxstyleliteralemphasis{string.}) \textendash{} El nombre de usuario que se desea consultar.
...
\index{generate\_token() (método de clase de app.models.user\_model.UserModel)}

\begin{fulllineitems}
\phantomsection\label{\detokenize{chapter_two/desc_cloudnao:app.models.user_model.UserModel.generate_token}}\pysiglinewithargsret{\sphinxbfcode{classmethod }\sphinxbfcode{generate\_token}}{}{}~\begin{quote}\begin{description}
\item[{Devuelve}] \leavevmode
...
\index{save\_to\_db() (método de app.models.user\_model.UserModel)}

\begin{fulllineitems}
\phantomsection\label{\detokenize{chapter_two/desc_cloudnao:app.models.user_model.UserModel.save_to_db}}\pysiglinewithargsret{\sphinxbfcode{save\_to\_db}}{}{}
Inserta un usuario en la base de datos.

\end{fulllineitems}

\index{verify\_password() (método de app.models.user\_model.UserModel)}

\begin{fulllineitems}
\phantomsection\label{\detokenize{chapter_two/desc_cloudnao:app.models.user_model.UserModel.verify_password}}\pysiglinewithargsret{\sphinxbfcode{verify\_password}}{\emph{password}}{}
Checa que la contraseña almacenada sea la misma que la que se pasa
como parámetros pasada a través de una función hash.
\begin{quote}\begin{description}
\item[{Parámetros}] \leavevmode
\sphinxstyleliteralstrong{password} (\sphinxstyleliteralemphasis{string.}) \textendash{} Contraseña sin aplicar el hash.

\item[{Devuelve}] \leavevmode
\sphinxcode{True} si son iguales, o \sphinxcode{False} de los contrario.
